...
const stats = [
  ...
  { value: `${businessInfo.stats.members.toLocaleString("it-IT")}+`, label: "Soci" },
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-foreground/85 leading-relaxed">
              Nato nel {businessInfo.stats.since}, Nettuno Gold è oggi uno dei punti di
              riferimento del Texas Hold&apos;em nel bolognese: {businessInfo.stats.areaSqm} m² di
              sala, {businessInfo.stats.tables} tavoli e uno staff che segue ogni torneo dal primo
              all&apos;ultimo livello.
            </p>
            <p className="text-foreground/85 leading-relaxed">
